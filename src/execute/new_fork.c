...
/*   Updated: 2022/12/08 18:04:35 by pbiederm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		infile_in_this_node(t_chunk **salt, int number_of_infiles);
...
// 	elements = *salt;
// 	if(elements->in_f != NULL && elements->in_f[number_of_infiles].name !=
// 	 NULL && elements->in_f[number_of_infiles].type == INPUT_F)
// 	{
// 		return(1);
// 	}
// 	else
...
void	execute(t_chunk **salt, t_info *info, char	**envp)
{
	...
	while(elements)
	{
		...
		// while(infile_in_this_node(&elements, vars->number_of_infiles))
		...
		{
			fprintf(stderr, "read infile vars->number_of_infiles %d\n", vars->number_of_infiles);
